...
//    [self showAdBanner];
    ...
    for(int i = 0; i < 2; i++)
    {
        [g_frmBird addSpriteFrameWithFilename:[NSString stringWithFormat:@"bird%d.png", i]];
    }
...
-(void) showAdBanner
{
    ...
    adView.frame = CGRectMake(0, G_SHEIGHT - 60 * G_SCALEY / g_fScaleR, G_SWIDTH, 60 * G_SCALEY / g_fScaleR);
...
//    if(!mIAd)
//    {
//        [ADBannerView alloc] initWithFrame:<#(CGRect)#>
